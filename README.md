...
<h3 align="center">
  Demo :- <a href="https://to.amanstark.com/avatar-js">Click Here</a>
</h3>
</br>
</br>
...
2. To select the avatar art style of your choice, enter the code name at `avatarStyle` in the config, for example, `const config = { avatarStyle: 'thumbs', };` To see each art style in action, go to the demo site :- [click here](https://to.amanstark.com/avatar-js).
